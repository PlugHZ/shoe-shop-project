...
--
-- Host: 127.0.0.1    Database: shoe_shop_db
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `slip_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `category` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ทั่วไป',
...
-- Dump completed on 2026-02-17 14:29:45
